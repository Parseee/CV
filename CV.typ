...
- #text("Навыки", weight: "bold"):
  ...
  - Работа с микроконтроллерами, отладка
    - прерывания, таймеры (PWM), протоколы взамодействия(UART, I2C, SPI, 1wire), основные паттерны работы с железом, Ceedling
  - CI, контейнеризация, Linux, пакетные менеджеры и тулчейны
...
- #project(
  ...
  - Проект в рамках курса RISC-V. Двухголосый midi контроллер с дисплеем для метаданных.
